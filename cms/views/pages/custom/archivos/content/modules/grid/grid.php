	 			...
	 			<div class="card rounded p-3 border-0 shadow my-3">
	 				...
	 				<div class="card-header bg-white border-0 p-0">
	 					...
	 					<div class="d-flex justify-content-between mb-2">
	 						...
	 						<div class="bg-white">
	 							<a href="<?php echo TemplateController::buildFileUrl($value->link_file) ?>" target="_blank">
								<i class="bi bi-box-arrow-up-right ps-2 btn p-0"></i>
								</a>
							</div>

							<div class="bg-white m-0">
								<svg  class="bi bi-copy copyLink" copy="<?php echo TemplateController::buildFileUrl($value->link_file) ?>" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" style="cursor:pointer">
